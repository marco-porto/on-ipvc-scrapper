...
const getSchedule = async (login, year, semester, klass, week) => {
	...
	parsedContent.forEach(item => {
		...
		let [_, className, classShortName, __, classType] = item.datauc.split('-')
...
const getScheduleByDate = (login, scheduleYear, semester, klass, year, month, day) => {
	console.log(scheduleYear, semester, klass, year, month, day)
	...
	return getSchedule(login, scheduleYear, semester, klass, STATIC_DATE + scheduleWeek)
}
